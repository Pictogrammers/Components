...
| `inputModeSelectRectangle()` | -  | Input Mode Select Rectangle. Drags under 3px deselect (`Shift` keeps the selection). |
| `inputModeSelectEllipse()` | -  | Input Mode Select Ellipse. Drags under 3px deselect (`Shift` keeps the selection). |
| `inputModeSelectLasso()` | -  | Input Mode Lasso. Drags under 3px deselect (`Shift` keeps the selection). |
